...
import com.yxs.subject.infra.basic.mapper.SubjectMappingDao;
...
public class SubjectMappingServiceImpl implements SubjectMappingService {
    ...
    @Override
    public List<SubjectMapping> queryLabelIdListByCategoryId(SubjectMapping subjectMapping) {
        List<SubjectMapping> subjectMappingList = this.subjectMappingDao.queryLabelIdListByCategoryId(subjectMapping);
        return subjectMappingList == null ? Collections.emptyList() : subjectMappingList;
    }
